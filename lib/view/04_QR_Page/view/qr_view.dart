                          ...
                          WidgetsBinding.instance.addPostFrameCallback((_) {
                            ...
                            if (isSuccess) {
                              ...
                              ScaffoldMessenger.of(context)
                                  .showSnackBar(SnackBar(content: Text('Invalid QR')));
                            }
                          });
                        },
                      ),
                              ...
                              Container(
                                ...
                                child: OutlinedButton(
                                  ...
                                  style: OutlinedButton.styleFrom(
                                    ...
                                    // Text and icon color
                                    side: BorderSide(
                                        color: Color(0xff50c400), width: 3),
...
class LShapePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (size.width < 400) {
      ...
      //horizontal
      canvas.drawRect(
          Rect.fromLTWH(cornerSizeSmall * 3, cornerSizeSmall * 2,
              cornerSizeSmall * 1.5, lineThickness),
          paint);
      //vertical
      canvas.drawRect(
          Rect.fromLTWH(cornerSizeSmall * 3, cornerSizeSmall * 2.2,
              lineThickness, cornerSizeSmall * 1.5),
          paint);

      // Top right corner
      //horizontal
      canvas.drawRect(
          Rect.fromLTWH(size.width - (cornerSizeSmall * 4.5),
              cornerSizeSmall * 2, cornerSizeSmall * 1.5, lineThickness),
          paint);
      //vertical
      canvas.drawRect(
          Rect.fromLTWH(size.width - (cornerSizeSmall * 3.3),
              cornerSizeSmall * 2.2, lineThickness, cornerSizeSmall * 1.5),
          paint);

      // Bottom left corner
      //horizontal
      canvas.drawRect(
          Rect.fromLTWH(cornerSizeSmall * 3, cornerSizeSmall * 15,
              cornerSizeSmall * 1.5, lineThickness),
          paint);
      //vertical
      canvas.drawRect(
          Rect.fromLTWH(cornerSizeSmall * 3, cornerSizeSmall * 13.8,
              lineThickness, cornerSizeSmall * 1.5),
          paint);
      ...
      //horizontal
      canvas.drawRect(
          Rect.fromLTWH(cornerSizeSmall * 15.5, cornerSizeSmall * 15,
              cornerSizeSmall * 1.5, lineThickness),
          paint);
      //vertical
      canvas.drawRect(
          Rect.fromLTWH(cornerSizeSmall * 16.7, cornerSizeSmall * 13.8,
              lineThickness, cornerSizeSmall * 1.5),
          paint);
    } else {
      // Top left corner
      ...
      canvas.drawRect(
          Rect.fromLTWH(
              cornerSize, cornerSize * 2, cornerSize * 1.5, lineThickness),
          paint);
      //vertical
      canvas.drawRect(
          Rect.fromLTWH(
              cornerSize, cornerSize * 2.2, lineThickness, cornerSize * 1.5),
          paint);

      // Top right corner
      //horizontal
      canvas.drawRect(
          Rect.fromLTWH(size.width - (cornerSize * 2.49), cornerSize * 2,
              cornerSize * 1.5, lineThickness),
          paint);
      //vertical
      canvas.drawRect(
          Rect.fromLTWH(size.width - (cornerSize * 1.1), cornerSize * 2.2,
              lineThickness, cornerSize * 1.5),
          paint);
      ...
      canvas.drawRect(
          Rect.fromLTWH(
              cornerSize, cornerSize * 10, cornerSize * 1.5, lineThickness),
          paint);
      //vertical
      canvas.drawRect(
          Rect.fromLTWH(
              cornerSize, cornerSize * 8.5, lineThickness, cornerSize * 1.5),
          paint);

      // Bottom right corner
      //horizontal
      canvas.drawRect(
          Rect.fromLTWH(cornerSize * 7.5, cornerSize * 10, cornerSize * 1.5,
              lineThickness),
          paint);
      //vertical
      canvas.drawRect(
          Rect.fromLTWH(cornerSize * 8.9, cornerSize * 8.5, lineThickness,
              cornerSize * 1.5),
          paint);
    }
  }
